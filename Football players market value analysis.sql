...
#COMPUTE THE AVERAGE MARKETVALUE OF ALL PLAYERS
...
FROM sys.players_2
WHERE Name NOT RLIKE '^[aeiouyAEIOUY].*$'

#CATEGORIZE PLAYERS BY THEIR AGE
SELECT Name, Age,
CASE
