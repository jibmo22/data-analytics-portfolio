#THE TOTAL NUMBER OF DIFFERENT PRODUCTS AVAILABLE
SELECT COUNT(DISTINCT(Product)) AS PRODUCT
FROM products

#THE RELATIVE COUNT OF EACH PRODUCT TYPE
SELECT Category,
       ROUND((COUNT(*)/(SELECT COUNT(*) FROM products))*100, 0) as percentage
FROM products
GROUP BY Category

#THE RELATIVE COUNT OF PRODUCTS BY TYPE AND SIZE
...
#THE MOST POPULAR PRODUCT BY QUANTITY SOLD
...
#THE NUMBER OF PLACED ORDERS BY EACH COUNTRY
