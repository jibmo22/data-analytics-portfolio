...
#COUNT THE NUMBER OF PLAYERS WORTH 100 MILLION OR MORE
SELECT COUNT(*)
FROM players
WHERE MarketValue >= 100
ORDER BY MarketValue DESC

#THE AVERAGE MARKETVALUE OF ALL THE PLAYERS
SELECT AVG(Marketvalue) AS AVG_MARKETVALUE
FROM players

#THE TOP 3 PLAYERS WHO HAVE THE HIGHEST GOAL RATIOS PER GAME
...
#COUNT THE NUMBER OF PLAYERS WHOSE NAMES DO NOT START WITH A VOWEL
SELECT COUNT(DISTINCT Name)
FROM players
WHERE Name NOT RLIKE '^[aeiouAEIOU].*$'

#CATEGORIZE PLAYERS BY AGE AND GET AVERAGE MARKET VALUE FOR A PLAYER IN THAT CATEGORY
